...
// 				var size = 10;
// 				var arr = [["userName", $("#onSearchUser #userName").val()],
// 						["startTime", $("#onSearchUser #userstartTime").val()],
// 						["endTime", $("#onSearchUser #userendTime").val()],
// 						["recordType", $("#onSearchUser2 #recordType").val()],
// 						["operator", $("#onSearchUser2 #operator").val()],
// 						["loginTimes", $("#loginTimes_1").val()]];
// 				var urls = getUrl(arr);
// 				var url = '/APP-admin/user/getUserList?page=' + page
// 						+ '&size=' + size + "&" + urls;
...
// 					var arr = [
// 							["userName", $("#onSearchUser #userName").val()],
// 							["startTime",
// 									$("#onSearchUser #userstartTime").val()],
// 							["endTime", $("#onSearchUser #userendTime").val()],
// 							["recordType",
// 									$("#onSearchUser2 #recordType").val()],
// 							["operator", $("#onSearchUser2 #operator").val()],
// 							["loginTimes", $("#loginTimes_1").val()]];
// 					var urls = getUrl(arr);
...
// 				var loginTimes = $(contaner).find(".times").val();
