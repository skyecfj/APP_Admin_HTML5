		...
		function E(K, J) {
			...
			function C() {
				...
				for (var C = 0; C < D.length; C++)
					if (D[C].name == J.skin)
					$.push("<link rel='stylesheet' type='text/css' href='"+ A +"skin/whyGreen/datepicker.css' charset='"+ D[C].name + D[C].charset +"' />")
						// $.push(""
						// 		+ A
						// 		+ "<link rel=\"stylesheet\" type=\"text/css\" href=\"./assets/js/skin/whyGreen/datepicker.css\" charset=\""
						// 		+ D[C].name
						// 		+ ""
						// 		+ D[C].charset + "\"/>");
				$.push("<script src='"+ A +"calendar.js'></script>");
				// $.push("<script src=" + A + "\"../../../js/calendar.js\"></script>");
