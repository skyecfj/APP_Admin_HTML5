...
(function (factory) {
  ...
  var Editor = function (context) {
     ...
     */
    this.empty = function () {
      context.invoke('code.html', dom.emptyPara);
    };
  };
  ...
  var AutoSync = function (context) {
    ...
    this.events = {
      'summernote.change': function () {
        $note.val(context.invoke('code.html'));
      }
    };
    ...
    this.addImagePopoverButtons = function () {
      ...
      context.memo('button.floatLeft', function () {
        return ui.button({
          ...
          click: context.createInvokeHandler('editor.floatMe', 'left.html')
        }).render();
      });
  ...
  var HintPopover = function (context) {
    ...
    this.nodeFromItem = function ($item) {
      var hint = hints[$item.data('index.jsp.html.jsp.html.jsp.html')];
